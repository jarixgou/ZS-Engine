...
public:
    ...
    /// cellTexture.create(windowSize.x, windowSize.y);
    /// cellTexture.update(window);
    /// sf::Image screenshot = cellTexture.copyToImage();
    /// \endcode
    ///
    ...
    /// You can also draw things directly to a cellTexture with the
...
///
/// // Create a spr and a text to display
/// sf::Sprite spr;
/// sf::Text text;
/// ...
///
