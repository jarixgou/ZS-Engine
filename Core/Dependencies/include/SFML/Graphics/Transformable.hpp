...
/// pixels spr. By default, the spr is positioned/rotated/scaled
/// relatively to its top-left corner, because it is the local point
/// (0, 0). But if we change the origin to be (5, 5), the spr will
...
/// origin for all the components. You cannot position the spr
...
/// to texels (pixels in the cellTexture). More specifically, this means:
