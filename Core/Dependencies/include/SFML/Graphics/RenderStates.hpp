...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct a default set of render states with a custom cellTexture
    ///
...
/// \li the cellTexture: what image is mapped to the object
/// \li the shader: what custom effect is applied to the object
///
/// High-level objects such as sprites or text force some of
/// these states when they are drawn. For example, a spr
/// will set its own cellTexture, so that you don't have to care
/// about it when drawing the spr.
///
...
/// current transform with its own transform. A spr will
/// set its cellTexture. Etc.
///
