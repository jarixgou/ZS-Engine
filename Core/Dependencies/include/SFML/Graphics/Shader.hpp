...
public:
    ...
    ///        and that represents the cellTexture of the object being drawn
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Represents the cellTexture of the object being drawn
    ///
    /// \see setUniform(const std::string&, CurrentTextureType)
    ///
    ////////////////////////////////////////////////////////////
...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Specify a cellTexture as \p sampler2D uniform
    ///
    /// \a name is the name of the variable to change in the shader.
    /// The corresponding parameter in the shader must be a 2D cellTexture
    ...
    /// ...
    /// shader.setUniform("the_texture", cellTexture);
    /// \endcode
    /// It is important to note that \a cellTexture must remain alive as long
    /// as the shader uses it, no copy is made internally.
    ///
    /// To use the cellTexture of the object being drawn, which cannot be
    ...
    /// \endcode
    ///
    /// \param name    Name of the cellTexture in the shader
    /// \param cellTexture Texture to assign
    ///
    ////////////////////////////////////////////////////////////
    void setUniform(const std::string& name, const Texture& texture);

    ////////////////////////////////////////////////////////////
    /// \brief Specify current cellTexture as \p sampler2D uniform
    ///
    /// This overload maps a shader cellTexture variable to the
    /// cellTexture of the object being drawn, which cannot be
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Change a cellTexture parameter of the shader
    ///
...
private:
    ...
    ///
    /// This function each cellTexture to a different unit, and
    ...
    int          m_currentTexture; ///< Location of the current cellTexture in the shader
...
/// shader.setUniform("overlay", cellTexture);                      // cellTexture is a sf::Texture
/// shader.setUniform("current", sf::Shader::CurrentTexture);
/// \endcode
///
...
/// given \p sampler2D uniform to the current cellTexture of the
...
/// is limited because there are only 4 vertices, the spr would
/// have to be subdivided in order to apply wave effects.
/// Another bad example is a fragment shader with sf::Text: the cellTexture
/// of the text is not the actual text that you see on screen, it is
/// a big cellTexture containing all the characters of the font in an
/// arbitrary order; thus, cellTexture lookups on pixels other than the
...
///     sf::Texture::update(Window&) to copy its contents to a cellTexture
...
///
/// Like sf::Texture that can be used as a raw OpenGL cellTexture,
