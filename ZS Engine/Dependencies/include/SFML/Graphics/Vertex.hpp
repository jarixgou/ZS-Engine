...
{
////////////////////////////////////////////////////////////
/// \brief Define a point with color and cellTexture coordinates
///
////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// The vertex color is white and cellTexture coordinates are (0, 0).
    ///
    ...
    ///
    /// The cellTexture coordinates are (0, 0).
    ///
    /// \param thePosition Vertex position
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct the vertex from its position and cellTexture coordinates
    ///
    /// The vertex color is white.
    ///
    /// \param thePosition  Vertex position
    /// \param theTexCoords Vertex cellTexture coordinates
    ///
    ////////////////////////////////////////////////////////////
    Vertex(const Vector2f& thePosition, const Vector2f& theTexCoords);

    ////////////////////////////////////////////////////////////
    /// \brief Construct the vertex from its position, color and cellTexture coordinates
    ///
    /// \param thePosition  Vertex position
    /// \param theColor     Vertex color
    /// \param theTexCoords Vertex cellTexture coordinates
    ...
    Vector2f  texCoords; ///< Coordinates of the cellTexture's pixel to map to the vertex
};
...
/// vertices also have a color and a pair of cellTexture coordinates.
///
...
/// sprites, texts, etc.
///
/// If you use the graphical entities of SFML (spr, text, shape)
...
/// Example:
/// \code
/// // define a 100x100 square, red, with a 10x10 cellTexture mapped on it
/// sf::Vertex vertices[] =
/// {
...
/// \endcode
///
/// Note: although cellTexture coordinates are supposed to be an integer
