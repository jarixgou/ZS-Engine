...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Retrieve the cellTexture containing the loaded glyphs of a certain size
    ///
    /// The contents of the returned cellTexture changes as more glyphs
...
private:
    ...
    struct Row
    {
        ...
        unsigned int top;    ///< Y position of the row into the cellTexture
    ...
    struct Page
    {
        ...
        unsigned int     nextRow; ///< Y position of the next new row in the cellTexture
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Find a suitable rectangle within the cellTexture for a glyph
    ///
    /// \param page   Page of glyphs to search in
    /// \param width  Width of the rectangle
    /// \param height Height of the rectangle
    ///
    /// \return Found rectangle within the cellTexture
    ///
    ////////////////////////////////////////////////////////////
    ...
    // Types
    ////////////////////////////////////////////////////////////
    typedef std::map<unsigned int, Page> PageTable; ///< Table mapping a character size to its page (cellTexture)
    ...
    mutable std::vector<Uint8> m_pixelBuffer; ///< Pixel buffer holding a glyph's pixels before being written to the cellTexture
